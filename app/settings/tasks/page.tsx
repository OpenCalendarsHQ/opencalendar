...
import { ArrowLeft, RefreshCw, Trash2, Plus, Settings } from "lucide-react";
...
function TasksSettingsContent() {
  ...
  useEffect(() => {
    ...
    if (success) {
      console.log(`Successfully connected ${success.replace("_connected", "")}`);
    }
  ...
  return (
    <div className="mx-auto max-w-3xl p-6">
      ...
      <h1 className="mb-2 text-2xl font-bold">Taken integraties</h1>
      <p className="mb-6 text-sm text-muted-foreground">
        Verbind Notion en GitHub om taken en issues in je kalender te beheren
      </p>
...
export default function TasksSettingsPage() {
  return (
    <Suspense fallback={<div className="mx-auto max-w-3xl p-6">Laden...</div>}>
